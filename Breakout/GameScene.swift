...
//  Breakout
//
//  Created by Dhanush Tipparaju on 3/8/23.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeBall() {
        ...
        //use percice collision detection
    ...
    func makePaddle() {
        paddle.removeFromParent() // removes the paddle if it already exists
